...
| OpenStreetMap outage or rate limit | Known boundaries are stored and reused; errors return safely | A first visit to an unknown place may fail. Production could use a permitted cache/proxy and monitored retry policy. |

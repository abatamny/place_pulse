...
- GitHub Actions: backend tests, frontend build, and fresh four-service startup configured.
...
Azure provisioning is prepared but optional and was not executed automatically because it creates billable resources. The demonstration video is a submission artifact and must be recorded and linked after the final UI walkthrough.
